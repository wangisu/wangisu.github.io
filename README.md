...
This is a simple example of creating a personal homepage using the xxx.github.io driver. 

Equipped with a personal blog to create a blog post to recommend the use of hexo
